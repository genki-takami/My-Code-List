...
final class DisplayListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "displayDetailsCellSegue"{
            let readingDisplayContentViewController:DisplayViewController = segue.destination as! DisplayViewController
