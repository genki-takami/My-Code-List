...
class ReadingShopViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "shopDetailsCellSegue"{
            let readingShopContentViewController:ReadingShopContentViewController = segue.destination as! ReadingShopContentViewController
