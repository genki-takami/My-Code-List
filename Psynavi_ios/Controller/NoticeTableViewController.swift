...
class NoticeTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?){
        ...
        case "noticeCellSegue":
            let noticeEditViewController:NoticeEditViewController = segue.destination as! NoticeEditViewController
